...
DDD                                                 & 10                                                & 100,000                                             & 0.1                     & 4.0                     & 0.0                     & ${0.9\lambda_0}^*$                     & 10                 & 1000                 \\\bottomrule
\end{tabular}
\newline
\vspace{0.2 cm}
\newline
...
\multicolumn{1}{c}{\multirow{2}{*}{\textbf{Type}}} & \multicolumn{1}{c}{\multirow{2}{*}{\textbf{Age}}} & \multicolumn{1}{c}{\multirow{2}{*}{\textbf{N}}} & \multicolumn{2}{c}{\textbf{$\lambda_1$}}                  & \multicolumn{2}{c}{\textbf{$\log_{10}(\lambda_2)$}}                  & \multicolumn{2}{c}{\textbf{$\lambda_3$}}                  & \multicolumn{2}{c}{\textbf{$\mu_1$}}                  & \multicolumn{2}{c}{\textbf{$\mu_2$}}                  \\ \cmidrule(l){4-5} \cmidrule(l){6-7} \cmidrule(l){8-9} \cmidrule(l){10-11} \cmidrule(l){12-13} 
...
PBD                                                 & 10                                                & 100,000                                              & 0.1                     & 1.0         & -3                     & \multicolumn{1}{c}{1}                     & 0.1                     & 1.0                     & 0.0                     & 0.8$\lambda_1$                     & 0.0                     & 0.8$\lambda_3$                     \\ \bottomrule
\end{tabular}