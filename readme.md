...
[![Latest release](https://img.shields.io/github/v/release/EvoLandEco/Thesis?display_name=tag&sort=semver)](https://github.com/EvoLandEco/Thesis/releases/latest)
[![Pre-release](https://img.shields.io/github/v/release/EvoLandEco/Thesis?include_prereleases&label=pre-release)](https://github.com/EvoLandEco/Thesis/releases)
